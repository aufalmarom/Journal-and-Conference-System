...
@section('content')
    ...
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
            ...
            <h3 class="page-title">Sponsorship Section</h3>
        </div>
    </div>
    <!-- End Page Header -->
            ...
            <ul class="list-group list-group-flush">
              <li class="list-group-item p-3">
                <div class="row">
                  ...
                  <form method="POST" action="{{route('sponsorship.post')}}" enctype="multipart/form-data">
                    @csrf
                        <div class="row">
                            <div class="col-sm-5">
                            ...
                            <div class="col-sm-5">
                                <div class="form-group text-center">
                                    <strong class="text-muted d-block mb-2">Sponsorship Name</strong>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group text-center">
                        ...
                        <p class="small">*max size : 100KB</p>
                        ...
                        <script>
                               ...
                               function dynamic() {
                                    ...
                                    divtest.innerHTML = '<div class="col-sm-5"><div class="form-group custom-file"><input type="hidden" name="id[]"><input type="file" class="custom-file-input" name="photo[]" required><label class="custom-file-label" for="validatedCustomFile"></label></div></div><div class="col-sm-5"><div class="form-group"><input type="text" name="name[]" class="form-control" id="validationServer03" placeholder="name" required></div></div><div class="col-sm-2"><div class="form-group text-center"><button type="button" onclick="remove_dynamic(' + room + ')" class="btn btn-danger">-</button></div></div>';
