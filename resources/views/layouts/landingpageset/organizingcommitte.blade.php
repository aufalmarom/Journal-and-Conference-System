...
@section('content')
    ...
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
            ...
            <h3 class="page-title">Organizing Committe Section</h3>
        </div>
    </div>
    <!-- End Page Header -->
            ...
            <ul class="list-group list-group-flush">
              <li class="list-group-item p-3">
                <div class="row">
                  ...
                  <form method="POST" action="{{route('organizingcommitte.post')}}">
                    @csrf
                        <div class="row">
                            <div class="col-sm-5">
                                <div class="form-group text-center">
                                    <strong class="text-muted d-block mb-2">Organizing Committe Name</strong>
                                </div>
                            </div>
                            <div class="col-sm-5">
                                <div class="form-group text-center">
                        ...
                        <div class="row removeclass{{$data->id}}">
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    <input type="text" name="position[]" class="form-control" placeholder="Position" value="{{$data->position}}" required>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group text-center">
                        ...
                        <script>
                            ...
                            function dynamic() {
                                ...
                                divtest.innerHTML = '<div class="col-sm-5"><div class="form-group"><input type="text" name="name[]" class="form-control" placeholder="name" required></div></div><div class="col-sm-5"><div class="form-group"><input type="text" name="position[]" class="form-control" placeholder="position" required></div></div><div class="col-sm-1"><div class="form-group text-center"><button type="button" onclick="remove_dynamic(' + room + ')" class="btn btn-danger">-</button></div></div>';
