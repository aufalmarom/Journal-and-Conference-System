...
@section('content')
    ...
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
            ...
            <h3 class="page-title">Scientific Committe Section</h3>
        </div>
    </div>
    <!-- End Page Header -->
            ...
            <ul class="list-group list-group-flush">
              <li class="list-group-item p-3">
                <div class="row">
                  ...
                  <form method="POST" action="{{route('scientificcommitte.post')}}" enctype="multipart/form-data">
                    @csrf
                        <div class="row">
                            <div class="col-sm-10">
                                <div class="form-group text-center">
                                    <strong class="text-muted d-block mb-2">Scientific Committe Name</strong>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group text-center">
                        ...
                        <script>
                            ...
                            function dynamic() {
                                ...
                                divtest.innerHTML = '<div class="col-sm-10"><div class="form-group"><input type="text" name="name[]" class="form-control" placeholder="name" required></div></div><div class="col-sm-2"><div class="form-group text-center"><button type="button" onclick="remove_dynamic(' + room + ')" class="btn btn-danger">-</button></div></div>';
