        ...
        <div class="col">
            <table id="myTable" class="ui celled table" style="width:100%">
                ...
                <tbody>
                    ...
                    @for ($i = 0; $i < count($data->ppt); $i++)
                    @if ($data->id == $data->ppt[$i]->id_paper)
                    <td class="text-center">
                        <a class="btn btn-accent" title="Download Powerpoint" href="{{route('downloadppt', $data->ppt[$i]->id_paper)}}"><i class="material-icons">archive</i></a>
                    </td>
                    @endif
                    @endfor
                    </tr>
