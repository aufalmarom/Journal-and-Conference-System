    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card-header border-bottom">
                <h6 class="m-0">Submit Full Paper Underview</h6>
            </div>
            <ul class="list-group list-group-flush">
                <li class="list-group-item p-3">
                <div class="row">
                    <div class="col">
                    <form method="POST" action="{{route('fullpaperunderview.post')}}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row text-left">
                            <div class="col-sm-6">
                                <button type="submit" class="btn btn-accent">Submit Paper Underview</button>
                            </div>
                        </div>
                    </form>
                    </div>
