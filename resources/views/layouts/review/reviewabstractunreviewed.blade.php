        ...
        <div class="col">
            <table id="myTable" class="ui celled table" style="width:100%">
                ...
                <tbody>
                    ...
                    <form method="POST" action="{{route('abstractafterreview.post')}}">
                        @csrf
                        <td class="text-center">
                            <input  type="hidden" name="id" value="{{$data->id}}">
                            <button type="submit" class="btn btn-accent" title="See Abstract after review"><i class="material-icons">book</i></button>
                        </td>
                    </form>
